  ...
  <div class="content">
    ...
    <div style="direction:rtl" v-if="this.refreshPage" class="container-fluid">
      ...
      <div class="row" v-bind:class="[this.tab1 ? '' : 'vpc_nav_item_selected_form']">
        <singleInputDisabled type="text" inputTitle="ثبت کننده" v-model="this.data.sender"></singleInputDisabled>
        <listMultiSelector
          listName="گیرنده"
          selectedItem="name"
  ...
  data() {
    return {
      ...
      window: {
        headerid: "dlsForm",
        title: "ثبت پیشنویس",
        titleLine: "کارتابل پیشنویس ها / ثبت پیش نویس",
      },

      submit: {
        buttonTitle: "ثبت",
        axiosUrl: "/api/v1/dlsRegister",
      },
      data: {
        sender:
  ...
  methods: {
    ...
    refresh() {
      ...
      setTimeout(() => {
        ...
        this.data.sender = this.getUserInfo;
      }, 1000);
    },
    // refresh
    showTab1() {
