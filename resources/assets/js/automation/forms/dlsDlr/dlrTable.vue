...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "dlrTable",
        title: "لیست پیش نویس های دریافتی",
        titleLine: "کارتابل پیشنویس ها/پیشنویس های ارسالی",
      },

      table: {
        selectStore: "DlsDlrStore",
        getData: "dlrTable",
        openSelectRow: ["automation", "dlrView", "مشاهده پیشنویس دریافتی"],
        selectRow: "selectDls",
        deleteRow: "",
        excel: "",
        fileNmae: "",
