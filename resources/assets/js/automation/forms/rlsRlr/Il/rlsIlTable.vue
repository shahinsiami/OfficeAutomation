...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "rlsIlTable",
        title: "لیست ارجاعات ارسال شده داخلی",
        titleLine: "کارتابل/ ارجاعات  / نامه های داخلی ارجاع کرده",
      },
      table: {
        selectStore: "RefferalStore",
        getData: "rlsIlTable",
        openSelectRow: ["automation", "rlsIlView", "نامه داخلی ارجاع کرده"],
        selectRow: "SelectRlsIl",
        deleteRow: "",
        excel: "",
        fileNmae: "",
        column: [
