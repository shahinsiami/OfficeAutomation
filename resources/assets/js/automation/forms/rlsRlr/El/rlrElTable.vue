...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "rlrElTable",
        title: "لیست ارجاعات دریافت شده خارجی",
        titleLine: "کارتابل/ ارجاعات  /نامه های خارجی ارجاع شده",
      },
      table: {
        selectStore: "RefferalStore",
        getData: "rlrElTable",
        openSelectRow: ["automation", "rlsElView", "نامه خارجی ارجاع شده"],
        selectRow: "SelectRlsEl",
        deleteRow: "",
        excel: "",
        fileNmae: "",
        column: [
