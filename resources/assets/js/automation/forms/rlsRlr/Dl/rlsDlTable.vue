...
export default {
  ...
  data() {
    return {
      window: {
        headerid: "rlsDlTable",
        title: "لیست پیشنویس ارجاع کرده",
        titleLine: "کارتابل/ ارجاعات  / پیش نویس های ارجاع کرده",
      },
      table: {
        selectStore: "RefferalStore",
        getData: "rlsDlTable",
        openSelectRow: ["automation", "rlsDlView", "پیش نویس ارجاع کرده"],
        selectRow: "SelectRlsDl",
        deleteRow: "",
        excel: "",
        fileNmae: "",
        column: [
