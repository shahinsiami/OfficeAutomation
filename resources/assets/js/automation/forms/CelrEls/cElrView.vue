...
export default {
  ...
  data() {
    return {
      ...
      window: {
        headerid: "cElrView",
        title: "نامه خارجی دریافت شده",
        titleLine:
          "کارتابل/ نامه های خارجی دریافتی / مشاهده نامه خارجی دریافتی",
      },
      simpleDataTable: {
        deleteRow: "/api/v1/deleteElrDocumentAttachment/",
        response: "selectcElrView",
      },
      data: {
        id: "",
        sender: "",
  ...
  computed: {
    lastId: {
      get() {
        if (this.$store.state.CelrElsStore.selectcElrView) {
    ...
    lastSender: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.sender;
      },
    },
    lastReceiver: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.receiver;
      },
    },
    last_Registrar: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.registrar;
      },
    },

    last_number_of_letter: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.number_of_letter;
      },
    },

    last_date_of_letter: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.date_of_letter;
      },
    },
    last_letter_priority: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.letter_priority;
      },
    },
    last_security: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.security;
      },
    },
    last_type_of_letter: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.type_of_letter;
      },
    },
    //
    lastSummary: {
    ...
    lastNote: {
      get() {
        if (this.$store.state.CelrElsStore.selectcElrView.summary) {
          return this.$store.state.CelrElsStore.selectcElrView.summary.note;
        } else {
          return "";
        }
      },
    ...
    lastHint: {
      get() {
        if (this.$store.state.CelrElsStore.selectcElrView.summary) {
          return this.$store.state.CelrElsStore.selectcElrView.summary.hint;
        } else {
          return "";
        }
      },
    ...
    lastAttachment: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.attachment;
      },
    },
    lastDocument: {
      get() {
        return this.$store.state.CelrElsStore.selectcElrView.document;
      },
    },
  },
  //compute
