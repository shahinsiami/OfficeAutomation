...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'percentage' => 'درصد',
        'priority' => 'اولویت',
        'main_category_id' => 'محموعه',
        'main_sub_category_id' => 'زیرمحموعه',
        'main_segment_id' => 'دسته',
        'main_event_id' => 'رویداد',
        'attribute' => 'شاخصه',
        'main_sub_segment_id' => 'زیردسته',
        'area_state_id' => 'استان',
        'area_city_id' => 'شهر',
        'area_zone_id' => 'منطقه',
        'superscription' => 'آدرس',
        ...
        'image8' => 'عکس شماره 8',
        'image9' => 'عکس شماره 9',
        'image10' => 'عکس شماره 10',
        'storename' => 'نام فروشکاه',
        'owner' => 'صاحب امتیاز',
        'postcode' => 'کدپستی',
        'cardnumber' => 'شماره حساب',
        'economiccode' => 'شماره اقتصادی',
        'companynumber' => 'شماره ثبت',
        'companynationalcode' => 'شماره ملی شرکت',
        'license' => 'گواهی',
        'stewardship' => 'مباشرت',
        'nationalcard' => 'شماره ملی',
        'officialnewspaper' => 'روزنامه رسمی',
        'registration' => 'ثبت',
        'activitypermission' => 'گواهی فعالیت',
        'formalrequest' => 'درخواست رسمی',
        'latestofficialnewspaper' => 'آخرین روزنامه رسمی',
        'brand' => 'برند',
        'madein' => 'ساخت',
        'details' => 'جزییات',
        'mall_id' => 'بازار تجاری',
        ...
        'seller_store_address_id' => 'شعبه فروش',
        'seller_store_id' => 'نام فروشگاه',
        'sender' => 'فرستنده',
        'receivers' => 'گیرنده',
        'receiver' => 'گیرنده',
        'date_of_entry' => 'تاریخ ورود',
        'date_of_letter' => 'تاریخ نامه',
        'security' => 'امنیت',
        'type_of_letter' => 'نوع نامه',
        'letter_priority' => 'اولویت نامه',
        'number_of_letter' => 'شماره نامه',
        ...
        'user_id' => 'کاربر',
        'tag' => 'برچسب',
        'page_language_id' => 'زبان',
        'page_tempalge_id' => 'قالب',
        'web_article_id' => 'محتوا',
    ],
];
